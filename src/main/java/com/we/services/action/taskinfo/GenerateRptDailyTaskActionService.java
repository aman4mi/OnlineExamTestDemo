...
@Service
@Component
public class GenerateRptDailyTaskActionService extends BaseService {
    ...
    public JasperPrint exportPdfFile(Map params) {
        try {
            log.info("-------- Task's Report printing------------ start----");
            System.out.println(Tools.convertToSonkha("10"));
            Map<String, Object> parameters = new HashMap<String, Object>();

            String jasperFileName = "dailytaskreport";
...
//            parameters.put("id", Long.parseLong(params.get("id").toString()));
            ...
            log.info("-------- Task's Report printing------------ stop----");
